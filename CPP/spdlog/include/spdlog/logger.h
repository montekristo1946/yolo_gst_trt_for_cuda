...
// Thread safe _logger (except for set_error_handler())
// Has name, log level, vector of std::shared sink pointers and formatter
// Upon each log write the _logger:
...
#define SPDLOG_LOGGER_CATCH()                                                                                                              \
    ...
    {                                                                                                                                      \
        err_handler_("Unknown exception in _logger");                                                                                       \
    }
#else
#define SPDLOG_LOGGER_CATCH()
#endif
...
#error SPDLOG_WCHAR_TO_UTF8_SUPPORT only supported on windows
    ...
    // set formatting for the sinks in this _logger.
    ...
    // create new _logger with same sinks and configuration.
